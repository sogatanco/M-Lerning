...
public class AdminUpdateDosen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dosen= FirebaseDatabase.getInstance().getReference("jurusan").child("tik").child("dosen").child(getIntent().getStringExtra("id"));
        ...
        save.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                dosen.child("itemName").setValue(nama.getText().toString().trim());
                dosen.child("itemAlamat").setValue(alamat.getText().toString().trim());
                dosen.child("itemTempat").setValue(tempat.getText().toString().trim());
                dosen.child("itemTglLahir").setValue(tgllahir.getText().toString().trim());
                dosen.child("itemJk").setValue(jk.getSelectedItem().toString().trim());
                Toast.makeText(AdminUpdateDosen.this, "Data Updated", Toast.LENGTH_LONG).show();
                finish();
            }
        });
    }
