...
public class AdminAddMahasiswaForm extends AppCompatActivity {
    AppCompatTextView title;
    Spinner jk;
    FirebaseAuth firebaseAuth2;
    DatabaseReference mahasiswa, users;
    TextView save;
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!TextUtils.isEmpty(vemail) && !TextUtils.isEmpty(vpassword) && !TextUtils.isEmpty(vnama) && !TextUtils.isEmpty(valamat)
                    ...
                    firebaseAuth2.createUserWithEmailAndPassword(vemail, vpassword).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            if (!task.isSuccessful()) {
                                ...
                                Toast.makeText(AdminAddMahasiswaForm.this, ex, Toast.LENGTH_LONG).show();
                            }
                            else
                            {
                                UserItem mahasiswaitem=new UserItem(firebaseAuth2.getUid(), vnama, vemail, vpassword, vjk, vtempat, vtgllahir, valamat);
                                mahasiswa.child(firebaseAuth2.getUid()).setValue(mahasiswaitem);
                                LevelItem levelItem=new LevelItem("mahasiswa");
                                users.child(firebaseAuth2.getUid()).setValue(levelItem);
                                Toast.makeText(AdminAddMahasiswaForm.this, "Mahasiswa Added ",Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(AdminAddMahasiswaForm.this, "Fields can't be empty", Toast.LENGTH_LONG).show();
                }
